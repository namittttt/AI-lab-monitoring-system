...
export async function uploadScreenshot(localPath, opts = {}) {
  ...
  if (deleteLocal) {
    try {
      ...
      console.warn('Failed to delete local screenshot', err.message);
    }
  }
    ...
    const uploadStream = cloudinary.uploader.upload_stream(
      {
        ...
        resource_type: 'raw',   // ✅ keep raw for PDFs
        overwrite: true
      },
      (error, result) => {
